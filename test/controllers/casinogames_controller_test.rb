...
class CasinogamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create casinogame" do
    assert_difference("Casinogame.count") do
      post casinogames_url, params: { casinogame: { image: @casinogame.image, name: @casinogame.name } }
    end
  ...
  test "should update casinogame" do
    patch casinogame_url(@casinogame), params: { casinogame: { image: @casinogame.image, name: @casinogame.name } }
